...
const _hoisted_21 = { class: "hero-status-row" }
...
const _hoisted_26 = { class: "metric-card cpu-card" }
const _hoisted_27 = { class: "metric-card-head" }
const _hoisted_28 = { class: "processor-spec" }
const _hoisted_29 = { class: "metric-body" }
const _hoisted_30 = { class: "metric-value" }
const _hoisted_31 = {
  class: "load-average",
  "aria-label": "平均负载（1 分钟 / 5 分钟 / 15 分钟）"
}
const _hoisted_32 = { class: "load-average-item" }
const _hoisted_33 = { class: "load-average-item" }
const _hoisted_34 = { class: "load-average-item" }
const _hoisted_35 = ["aria-valuenow", "aria-valuetext"]
const _hoisted_36 = { class: "metric-card" }
const _hoisted_37 = { class: "metric-card-head" }
const _hoisted_38 = { class: "metric-body" }
const _hoisted_39 = { class: "metric-value" }
const _hoisted_40 = { class: "capacity-details" }
const _hoisted_41 = ["aria-valuenow", "aria-valuetext"]
const _hoisted_42 = { class: "metric-foot" }
const _hoisted_43 = { class: "metric-card" }
const _hoisted_44 = { class: "metric-card-head" }
const _hoisted_45 = { class: "metric-body" }
const _hoisted_46 = { class: "metric-value" }
const _hoisted_47 = { class: "capacity-details" }
const _hoisted_48 = ["aria-valuenow", "aria-valuetext"]
const _hoisted_49 = { class: "metric-foot" }
...
const _hoisted_55 = { class: "metric-foot" }
const _hoisted_56 = {
...
const _hoisted_59 = ["aria-pressed", "onClick"]
const _hoisted_60 = { class: "trend-summary" }
const _hoisted_61 = {
  key: 0,
  class: "trend-stats"
}
const _hoisted_62 = { class: "trend-stat-name" }
const _hoisted_63 = {
  ref: "trendSvg",
  class: "trend-svg",
...
const _hoisted_64 = ["points"]
const _hoisted_65 = ["points"]
const _hoisted_66 = ["points"]
const _hoisted_67 = {
  key: 0,
  class: "trend-hover-layer"
}
const _hoisted_68 = ["x1", "x2"]
const _hoisted_69 = ["cx", "cy"]
const _hoisted_70 = ["cx", "cy"]
const _hoisted_71 = ["cx", "cy"]
const _hoisted_72 = { class: "chart-time-axis" }
const _hoisted_73 = {
  key: 2,
  class: "chart-empty"
}
...
const _hoisted_75 = { class: "two-column" }
const _hoisted_76 = {
  class: "panel",
  "aria-labelledby": "services-title"
}
const _hoisted_77 = { class: "service-list" }
const _hoisted_78 = { class: "service-name" }
...
const _hoisted_83 = { class: "panel-head compact" }
const _hoisted_84 = { class: "alert-list" }
const _hoisted_85 = {
  key: 0,
...
return function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock(_Fragment, null, [
    ...
    _createElementVNode("main", _hoisted_5, [
      _createElementVNode("section", _hoisted_6, [
        ...
        _createElementVNode("div", _hoisted_20, [
          _createElementVNode("div", _hoisted_21, [
            ...
            _createElementVNode("span", _hoisted_22, _toDisplayString(_ctx.summary.version ? "v" + _ctx.summary.version : "版本加载中"), 1 /* TEXT */)
          ]),
      ...
      (_ctx.error)
        ? (_openBlock(), _createElementBlock("div", _hoisted_24, _toDisplayString(_ctx.error), 1 /* TEXT */))
        : _createCommentVNode("v-if", true),
      _createElementVNode("section", _hoisted_25, [
        _createElementVNode("article", _hoisted_26, [
          _createElementVNode("div", _hoisted_27, [
            _cache[14] || (_cache[14] = _createElementVNode("div", { class: "metric-label" }, "处理器负载", -1 /* CACHED */)),
            _createElementVNode("span", _hoisted_28, _toDisplayString(_ctx.host.cpu_count || "--") + " 核 CPU", 1 /* TEXT */),
            _createElementVNode("span", {
              class: _normalizeClass(["metric-state", _ctx.cpuStatusClass])
            }, _toDisplayString(_ctx.cpuStatus), 3 /* TEXT, CLASS */)
          ]),
          _createElementVNode("div", _hoisted_29, [
            _createElementVNode("div", _hoisted_30, _toDisplayString(_ctx.formatPercent(_ctx.metric.cpu_percent)), 1 /* TEXT */),
            _createElementVNode("div", _hoisted_31, [
              _createElementVNode("div", _hoisted_32, [
                _createElementVNode("strong", null, _toDisplayString(_ctx.formatLoad(_ctx.metric.load_1)), 1 /* TEXT */),
                _cache[15] || (_cache[15] = _createElementVNode("small", null, "1分", -1 /* CACHED */))
              ]),
              ...
              _createElementVNode("div", _hoisted_33, [
                ...
                _cache[16] || (_cache[16] = _createElementVNode("small", null, "5分", -1 /* CACHED */))
              ]),
              ...
              _createElementVNode("div", _hoisted_34, [
                ...
                _cache[17] || (_cache[17] = _createElementVNode("small", null, "15分", -1 /* CACHED */))
              ])
            ])
          ]),
          _createElementVNode("div", {
          ...
          _cache[20] || (_cache[20] = _createElementVNode("div", { class: "metric-foot" }, "当前整体 CPU 占用", -1 /* CACHED */))
        ]),
        _createElementVNode("article", _hoisted_36, [
          _createElementVNode("div", _hoisted_37, [
            _cache[21] || (_cache[21] = _createElementVNode("div", { class: "metric-label" }, "内存使用情况", -1 /* CACHED */)),
            _createElementVNode("span", {
          ...
          _createElementVNode("div", _hoisted_38, [
            _createElementVNode("div", _hoisted_39, _toDisplayString(_ctx.formatPercent(_ctx.metric.memory_percent)), 1 /* TEXT */),
          ...
          _createElementVNode("div", _hoisted_42, "当前可用 " + _toDisplayString(_ctx.formatBytes(_ctx.host.memory_available)), 1 /* TEXT */)
        ]),
        _createElementVNode("article", _hoisted_43, [
          _createElementVNode("div", _hoisted_44, [
            _cache[22] || (_cache[22] = _createElementVNode("div", { class: "metric-label" }, "系统盘使用情况", -1 /* CACHED */)),
            _createElementVNode("span", {
          ...
          _createElementVNode("div", _hoisted_45, [
            _createElementVNode("div", _hoisted_46, _toDisplayString(_ctx.formatPercent(_ctx.metric.disk_percent)), 1 /* TEXT */),
          ...
          _createElementVNode("div", _hoisted_49, "剩余空间 " + _toDisplayString(_ctx.formatBytes(_ctx.host.disk_free)), 1 /* TEXT */)
        ]),
        _createElementVNode("article", _hoisted_50, [
          _createElementVNode("div", _hoisted_51, [
            _cache[23] || (_cache[23] = _createElementVNode("div", { class: "metric-label" }, "活动告警", -1 /* CACHED */)),
            _createElementVNode("span", {
          ...
          _createElementVNode("div", _hoisted_52, [
            _createElementVNode("div", _hoisted_53, _toDisplayString(_ctx.alerts.length), 1 /* TEXT */)
          ]),
          _createElementVNode("div", {
            class: "progress-track",
            role: "progressbar",
          ...
          _createElementVNode("div", _hoisted_55, _toDisplayString(_ctx.servicesUp) + " / " + _toDisplayString(_ctx.services.length) + " 服务正常", 1 /* TEXT */)
        ])
      ]),
      _createElementVNode("section", _hoisted_56, [
        _createElementVNode("div", _hoisted_57, [
          ...
          _createElementVNode("div", _hoisted_58, [
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.ranges, (item) => {
              ...
              }, _toDisplayString(item.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_59))
            }), 128 /* KEYED_FRAGMENT */))
          ])
        ]),
        _createElementVNode("div", _hoisted_60, [
          _createElementVNode("span", null, [
            ...
            _cache[25] || (_cache[25] = _createTextVNode(" 个采样点"))
          ]),
          _cache[26] || (_cache[26] = _createElementVNode("span", null, "每 60 秒采集一次", -1 /* CACHED */)),
          _cache[27] || (_cache[27] = _createElementVNode("span", { class: "trend-legend" }, [
        ...
        (_ctx.history.length)
          ? (_openBlock(), _createElementBlock("div", {
              ...
              _cache[32] || (_cache[32] = _createElementVNode("div", { class: "chart-y-axis" }, [
              ...
              (_openBlock(), _createElementBlock("svg", _hoisted_63, [
                _cache[28] || (_cache[28] = _createStaticVNode("<g class=\"trend-grid\"><line x1=\"0\" y1=\"0\" x2=\"1000\" y2=\"0\"></line><line x1=\"0\" y1=\"65\" x2=\"1000\" y2=\"65\"></line><line x1=\"0\" y1=\"130\" x2=\"1000\" y2=\"130\"></line><line x1=\"0\" y1=\"195\" x2=\"1000\" y2=\"195\"></line><line x1=\"0\" y1=\"260\" x2=\"1000\" y2=\"260\"></line></g>", 1)),
                ...
                (_ctx.trendHover)
                  ? (_openBlock(), _createElementBlock("g", _hoisted_67, [
              ...
              (_ctx.trendHover)
                ? (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("span", null, [
                      _cache[29] || (_cache[29] = _createElementVNode("i", { class: "cpu" }, null, -1 /* CACHED */)),
                      _createTextVNode("CPU " + _toDisplayString(_ctx.formatPercent(_ctx.trendHover.cpu)), 1 /* TEXT */)
                    ]),
                    _createElementVNode("span", null, [
                      _cache[30] || (_cache[30] = _createElementVNode("i", { class: "memory" }, null, -1 /* CACHED */)),
                      _createTextVNode("内存 " + _toDisplayString(_ctx.formatPercent(_ctx.trendHover.memory)), 1 /* TEXT */)
                    ]),
                    _createElementVNode("span", null, [
                      _cache[31] || (_cache[31] = _createElementVNode("i", { class: "disk" }, null, -1 /* CACHED */)),
          ...
          : (_openBlock(), _createElementBlock("div", _hoisted_73, " 正在等待这个时间范围内的监控数据 ")),
        _createElementVNode("p", _hoisted_74, _toDisplayString(_ctx.trendDescription), 1 /* TEXT */)
      ]),
      _createElementVNode("section", _hoisted_75, [
        _createElementVNode("article", _hoisted_76, [
          _cache[33] || (_cache[33] = _createElementVNode("div", { class: "panel-head compact" }, [
            _createElementVNode("div", null, [
          ...
          _createElementVNode("div", _hoisted_77, [
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.services, (service) => {
              return (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("strong", null, [
                      ...
                      (service.buckets && service.buckets.length)
                        ? (_openBlock(), _createElementBlock("span", {
                          ...
                          }, " [" + _toDisplayString(service.buckets.join(', ')) + "]", 9 /* TEXT, PROPS */, _hoisted_79))
                        : _createCommentVNode("v-if", true)
                    ]),
                ...
                }, _toDisplayString(_ctx.restartBusy === service.service ? "处理中" : "重启"), 9 /* TEXT, PROPS */, _hoisted_80)
              ]))
            }), 128 /* KEYED_FRAGMENT */)),
            (!_ctx.services.length)
              ? (_openBlock(), _createElementBlock("div", _hoisted_81, "等待服务采样"))
              : _createCommentVNode("v-if", true)
          ])
        ]),
        _createElementVNode("article", _hoisted_82, [
          ...
          _createElementVNode("div", _hoisted_84, [
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.alerts, (alert) => {
              return (_openBlock(), _createElementBlock("div", {
                ...
                _cache[35] || (_cache[35] = _createElementVNode("span", { class: "alert-icon" }, "!", -1 /* CACHED */)),
                _createElementVNode("div", null, [
            ...
            (!_ctx.alerts.length)
              ? (_openBlock(), _createElementBlock("div", _hoisted_85, _cache[36] || (_cache[36] = [
      ...
      _cache[37] || (_cache[37] = _createElementVNode("footer", null, [
