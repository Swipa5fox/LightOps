...
const { createElementVNode: _createElementVNode, toDisplayString: _toDisplayString, openBlock: _openBlock, createElementBlock: _createElementBlock, createCommentVNode: _createCommentVNode, createTextVNode: _createTextVNode, normalizeClass: _normalizeClass, vModelText: _vModelText, withDirectives: _withDirectives, withModifiers: _withModifiers, normalizeStyle: _normalizeStyle, renderList: _renderList, Fragment: _Fragment, withKeys: _withKeys, createStaticVNode: _createStaticVNode } = Vue
...
const _hoisted_4 = { class: "user-menu" }
const _hoisted_5 = {
  key: 0,
...
const _hoisted_7 = { class: "user-menu-account" }
...
const _hoisted_11 = { class: "modal-head" }
...
const _hoisted_19 = { class: "page-shell" }
const _hoisted_20 = {
  class: "hero",
  "aria-labelledby": "page-title"
}
const _hoisted_21 = { class: "host-summary" }
const _hoisted_22 = {
  class: "hero-weather",
  "aria-label": "每日天气"
}
...
const _hoisted_29 = { class: "weather-picker" }
const _hoisted_30 = { class: "weather-picker-place" }
const _hoisted_31 = { class: "weather-picker-row" }
const _hoisted_32 = ["disabled"]
const _hoisted_33 = ["disabled"]
const _hoisted_34 = { class: "hero-status" }
const _hoisted_35 = { class: "hero-status-row" }
...
const _hoisted_40 = { class: "metric-card cpu-card" }
const _hoisted_41 = { class: "metric-card-head" }
const _hoisted_42 = { class: "processor-spec" }
const _hoisted_43 = { class: "metric-body" }
const _hoisted_44 = { class: "metric-value" }
const _hoisted_45 = {
  class: "load-average",
  "aria-label": "平均负载（1 分钟 / 5 分钟 / 15 分钟）"
}
const _hoisted_46 = { class: "load-average-item" }
...
const _hoisted_50 = { class: "metric-card" }
const _hoisted_51 = { class: "metric-card-head" }
const _hoisted_52 = { class: "metric-body" }
const _hoisted_53 = { class: "metric-value" }
const _hoisted_54 = { class: "capacity-details" }
const _hoisted_55 = ["aria-valuenow", "aria-valuetext"]
const _hoisted_56 = { class: "metric-foot" }
const _hoisted_57 = { class: "metric-card" }
const _hoisted_58 = { class: "metric-card-head" }
const _hoisted_59 = { class: "metric-body" }
const _hoisted_60 = { class: "metric-value" }
const _hoisted_61 = { class: "capacity-details" }
const _hoisted_62 = ["aria-valuenow", "aria-valuetext"]
const _hoisted_63 = { class: "metric-foot" }
const _hoisted_64 = { class: "metric-card" }
const _hoisted_65 = { class: "metric-card-head" }
const _hoisted_66 = { class: "metric-body" }
const _hoisted_67 = { class: "metric-value" }
...
const _hoisted_71 = { class: "panel-head" }
const _hoisted_72 = {
  class: "segment-control",
  "aria-label": "趋势时间范围"
}
const _hoisted_73 = ["aria-pressed", "onClick"]
const _hoisted_74 = { class: "trend-summary" }
const _hoisted_75 = {
  key: 0,
  class: "trend-stats"
}
const _hoisted_76 = { class: "trend-stat-name" }
const _hoisted_77 = {
  ref: "trendSvg",
  class: "trend-svg",
...
const _hoisted_82 = ["x1", "x2"]
const _hoisted_83 = ["cx", "cy"]
const _hoisted_84 = ["cx", "cy"]
const _hoisted_85 = ["cx", "cy"]
const _hoisted_86 = { class: "chart-time-axis" }
const _hoisted_87 = {
  key: 2,
  class: "chart-empty"
}
...
const _hoisted_89 = { class: "two-column" }
const _hoisted_90 = {
  class: "panel",
  "aria-labelledby": "services-title"
}
const _hoisted_91 = { class: "service-list" }
const _hoisted_92 = { class: "service-name" }
const _hoisted_93 = ["title"]
const _hoisted_94 = ["disabled", "onClick"]
const _hoisted_95 = {
  key: 0,
  class: "empty-state"
}
...
const _hoisted_97 = { class: "panel-head compact" }
const _hoisted_98 = { class: "alert-list" }
const _hoisted_99 = {
  key: 0,
...
return function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock(_Fragment, null, [
    _createElementVNode("header", _hoisted_1, [
      _cache[20] || (_cache[20] = _createElementVNode("div", { class: "brand" }, [
      ...
      _createElementVNode("div", _hoisted_2, [
        ...
        _createElementVNode("div", _hoisted_4, [
          _createElementVNode("button", {
            ...
            onClick: _cache[0] || (_cache[0] = (...args) => (_ctx.handleUserClick && _ctx.handleUserClick(...args)))
          }, [
          ...
          (_ctx.currentUser)
            ? (_openBlock(), _createElementBlock("div", _hoisted_6, [
                _createElementVNode("div", _hoisted_7, [
                  _cache[18] || (_cache[18] = _createElementVNode("span", null, "我的账户", -1 /* CACHED */)),
                ...
                _createElementVNode("button", {
                  ...
                  role: "menuitem",
                  onClick: _cache[1] || (_cache[1] = (...args) => (_ctx.openPasswordModal && _ctx.openPasswordModal(...args)))
                }, " 修改密码 "),
                _createElementVNode("button", {
                  type: "button",
                ...
                }, _toDisplayString(_ctx.logoutBusy ? "退出中…" : "退出登录"), 9 /* TEXT, PROPS */, _hoisted_8)
              ]))
            : _createCommentVNode("v-if", true)
        ]),
        (_ctx.isAdmin)
          ? (_openBlock(), _createElementBlock("button", {
              ...
              type: "button",
              class: "ghost-button",
              onClick: _cache[3] || (_cache[3] = (...args) => (_ctx.saveToken && _ctx.saveToken(...args)))
            }, "管理令牌"))
          : _createCommentVNode("v-if", true),
        _createElementVNode("button", {
          type: "button",
        ...
        }, _toDisplayString(_ctx.loading ? "刷新中" : "刷新"), 9 /* TEXT, PROPS */, _hoisted_9)
      ])
    ]),
      ...
      ? (_openBlock(), _createElementBlock("div", {
          ...
          _createElementVNode("div", _hoisted_10, [
            _createElementVNode("div", _hoisted_11, [
              _cache[21] || (_cache[21] = _createElementVNode("h2", { id: "password-title" }, "修改密码", -1 /* CACHED */)),
              _createElementVNode("button", {
                type: "button",
                class: "modal-close",
                "aria-label": "关闭",
            ...
            _createElementVNode("form", {
              ...
              _createElementVNode("label", _hoisted_12, [
                _cache[22] || (_cache[22] = _createElementVNode("span", null, "原密码", -1 /* CACHED */)),
              ...
              _createElementVNode("label", _hoisted_13, [
                _cache[23] || (_cache[23] = _createElementVNode("span", null, "新密码（至少 6 位）", -1 /* CACHED */)),
                _withDirectives(_createElementVNode("input", {
              ...
              _createElementVNode("label", _hoisted_14, [
                _cache[24] || (_cache[24] = _createElementVNode("span", null, "确认新密码", -1 /* CACHED */)),
                _withDirectives(_createElementVNode("input", {
              ...
              (_ctx.passwordError)
                ? (_openBlock(), _createElementBlock("p", _hoisted_15, _toDisplayString(_ctx.passwordError), 1 /* TEXT */))
                : _createCommentVNode("v-if", true),
              (_ctx.passwordSuccess)
                ? (_openBlock(), _createElementBlock("p", _hoisted_16, _toDisplayString(_ctx.passwordSuccess), 1 /* TEXT */))
                : _createCommentVNode("v-if", true),
              _createElementVNode("div", _hoisted_17, [
                ...
                }, _toDisplayString(_ctx.passwordBusy ? "保存中…" : "更改密码"), 9 /* TEXT, PROPS */, _hoisted_18)
              ])
            ], 32 /* NEED_HYDRATION */)
          ])
        ]))
    ...
    _createElementVNode("main", _hoisted_19, [
      _createElementVNode("section", _hoisted_20, [
        _createElementVNode("div", null, [
          _cache[25] || (_cache[25] = _createElementVNode("div", { class: "eyebrow" }, "SYSTEM OVERVIEW", -1 /* CACHED */)),
          _cache[26] || (_cache[26] = _createElementVNode("div", { class: "hero-heading" }, [
          ...
          _createElementVNode("div", {
            ...
            (_ctx.weather)
              ? (_openBlock(), _createElementBlock("div", _hoisted_24, [
                  ...
                  (_ctx.weatherTip)
                    ? (_openBlock(), _createElementBlock("span", _hoisted_25, _toDisplayString(_ctx.weatherTip), 1 /* TEXT */))
                    : _createCommentVNode("v-if", true)
                ]))
              : (_openBlock(), _createElementBlock("div", _hoisted_26, [
                  _cache[27] || (_cache[27] = _createElementVNode("strong", null, "--°", -1 /* CACHED */)),
            ...
            (_ctx.weather && _ctx.weatherCandidates.length > 1)
              ? (_openBlock(), _createElementBlock("div", _hoisted_27, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.weatherCandidates, (candidate) => {
                    ...
                    }, _toDisplayString(candidate.label.split("-").slice(-1)[0]), 11 /* TEXT, CLASS, PROPS */, _hoisted_28))
                  }), 128 /* KEYED_FRAGMENT */))
                ]))
              : _createCommentVNode("v-if", true)
          ], 2 /* CLASS */),
          _createElementVNode("div", _hoisted_29, [
            _createElementVNode("div", _hoisted_30, _toDisplayString(_ctx.weather ? _ctx.weather.location_label : "选择城市查看天气"), 1 /* TEXT */),
        ...
        _createElementVNode("div", _hoisted_34, [
          _createElementVNode("div", _hoisted_35, [
            ...
            _createElementVNode("span", _hoisted_36, _toDisplayString(_ctx.summary.version ? "v" + _ctx.summary.version : "版本加载中"), 1 /* TEXT */)
          ]),
      ...
      (_ctx.error)
        ? (_openBlock(), _createElementBlock("div", _hoisted_38, _toDisplayString(_ctx.error), 1 /* TEXT */))
        : _createCommentVNode("v-if", true),
      _createElementVNode("section", _hoisted_39, [
        _createElementVNode("article", _hoisted_40, [
          _createElementVNode("div", _hoisted_41, [
            _cache[29] || (_cache[29] = _createElementVNode("div", { class: "metric-label" }, "处理器负载", -1 /* CACHED */)),
            _createElementVNode("span", _hoisted_42, _toDisplayString(_ctx.host.cpu_count || "--") + " 核 CPU", 1 /* TEXT */),
            _createElementVNode("span", {
              class: _normalizeClass(["metric-state", _ctx.cpuStatusClass])
            }, _toDisplayString(_ctx.cpuStatus), 3 /* TEXT, CLASS */)
          ]),
          _createElementVNode("div", _hoisted_43, [
            _createElementVNode("div", _hoisted_44, _toDisplayString(_ctx.formatPercent(_ctx.metric.cpu_percent)), 1 /* TEXT */),
            _createElementVNode("div", _hoisted_45, [
              _createElementVNode("div", _hoisted_46, [
                _createElementVNode("strong", null, _toDisplayString(_ctx.formatLoad(_ctx.metric.load_1)), 1 /* TEXT */),
                _cache[30] || (_cache[30] = _createElementVNode("small", null, "1分", -1 /* CACHED */))
              ]),
              ...
              _createElementVNode("div", _hoisted_47, [
                ...
                _cache[31] || (_cache[31] = _createElementVNode("small", null, "5分", -1 /* CACHED */))
              ]),
              ...
              _createElementVNode("div", _hoisted_48, [
                ...
                _cache[32] || (_cache[32] = _createElementVNode("small", null, "15分", -1 /* CACHED */))
              ])
            ])
          ]),
          _createElementVNode("div", {
          ...
          _cache[35] || (_cache[35] = _createElementVNode("div", { class: "metric-foot" }, "当前整体 CPU 占用", -1 /* CACHED */))
        ]),
        _createElementVNode("article", _hoisted_50, [
          _createElementVNode("div", _hoisted_51, [
            _cache[36] || (_cache[36] = _createElementVNode("div", { class: "metric-label" }, "内存使用情况", -1 /* CACHED */)),
            _createElementVNode("span", {
          ...
          _createElementVNode("div", _hoisted_52, [
            _createElementVNode("div", _hoisted_53, _toDisplayString(_ctx.formatPercent(_ctx.metric.memory_percent)), 1 /* TEXT */),
          ...
          _createElementVNode("div", _hoisted_56, "当前可用 " + _toDisplayString(_ctx.formatBytes(_ctx.host.memory_available)), 1 /* TEXT */)
        ]),
        _createElementVNode("article", _hoisted_57, [
          _createElementVNode("div", _hoisted_58, [
            _cache[37] || (_cache[37] = _createElementVNode("div", { class: "metric-label" }, "系统盘使用情况", -1 /* CACHED */)),
            _createElementVNode("span", {
          ...
          _createElementVNode("div", _hoisted_59, [
            _createElementVNode("div", _hoisted_60, _toDisplayString(_ctx.formatPercent(_ctx.metric.disk_percent)), 1 /* TEXT */),
          ...
          _createElementVNode("div", _hoisted_63, "剩余空间 " + _toDisplayString(_ctx.formatBytes(_ctx.host.disk_free)), 1 /* TEXT */)
        ]),
        _createElementVNode("article", _hoisted_64, [
          _createElementVNode("div", _hoisted_65, [
            _cache[38] || (_cache[38] = _createElementVNode("div", { class: "metric-label" }, "活动告警", -1 /* CACHED */)),
            _createElementVNode("span", {
          ...
          _createElementVNode("div", _hoisted_66, [
            _createElementVNode("div", _hoisted_67, _toDisplayString(_ctx.alerts.length), 1 /* TEXT */)
          ]),
          _createElementVNode("div", {
            class: "progress-track",
            role: "progressbar",
          ...
          _createElementVNode("div", _hoisted_69, _toDisplayString(_ctx.servicesUp) + " / " + _toDisplayString(_ctx.services.length) + " 服务正常", 1 /* TEXT */)
        ])
      ]),
      _createElementVNode("section", _hoisted_70, [
        _createElementVNode("div", _hoisted_71, [
          ...
          _createElementVNode("div", _hoisted_72, [
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.ranges, (item) => {
              ...
              }, _toDisplayString(item.label), 11 /* TEXT, CLASS, PROPS */, _hoisted_73))
            }), 128 /* KEYED_FRAGMENT */))
          ])
        ]),
        _createElementVNode("div", _hoisted_74, [
          _createElementVNode("span", null, [
            ...
            _cache[40] || (_cache[40] = _createTextVNode(" 个采样点"))
          ]),
          _cache[41] || (_cache[41] = _createElementVNode("span", null, "每 60 秒采集一次", -1 /* CACHED */)),
          _cache[42] || (_cache[42] = _createElementVNode("span", { class: "trend-legend" }, [
        ...
        (_ctx.history.length)
          ? (_openBlock(), _createElementBlock("div", {
              ...
              _cache[47] || (_cache[47] = _createElementVNode("div", { class: "chart-y-axis" }, [
              ...
              (_openBlock(), _createElementBlock("svg", _hoisted_77, [
                _cache[43] || (_cache[43] = _createStaticVNode("<g class=\"trend-grid\"><line x1=\"0\" y1=\"0\" x2=\"1000\" y2=\"0\"></line><line x1=\"0\" y1=\"65\" x2=\"1000\" y2=\"65\"></line><line x1=\"0\" y1=\"130\" x2=\"1000\" y2=\"130\"></line><line x1=\"0\" y1=\"195\" x2=\"1000\" y2=\"195\"></line><line x1=\"0\" y1=\"260\" x2=\"1000\" y2=\"260\"></line></g>", 1)),
                ...
                (_ctx.trendHover)
                  ? (_openBlock(), _createElementBlock("g", _hoisted_81, [
              ...
              (_ctx.trendHover)
                ? (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("span", null, [
                      _cache[44] || (_cache[44] = _createElementVNode("i", { class: "cpu" }, null, -1 /* CACHED */)),
                      _createTextVNode("CPU " + _toDisplayString(_ctx.formatPercent(_ctx.trendHover.cpu)), 1 /* TEXT */)
                    ]),
                    _createElementVNode("span", null, [
                      _cache[45] || (_cache[45] = _createElementVNode("i", { class: "memory" }, null, -1 /* CACHED */)),
                      _createTextVNode("内存 " + _toDisplayString(_ctx.formatPercent(_ctx.trendHover.memory)), 1 /* TEXT */)
                    ]),
                    _createElementVNode("span", null, [
                      _cache[46] || (_cache[46] = _createElementVNode("i", { class: "disk" }, null, -1 /* CACHED */)),
          ...
          : (_openBlock(), _createElementBlock("div", _hoisted_87, " 正在等待这个时间范围内的监控数据 ")),
        _createElementVNode("p", _hoisted_88, _toDisplayString(_ctx.trendDescription), 1 /* TEXT */)
      ]),
      _createElementVNode("section", _hoisted_89, [
        _createElementVNode("article", _hoisted_90, [
          _cache[48] || (_cache[48] = _createElementVNode("div", { class: "panel-head compact" }, [
            _createElementVNode("div", null, [
              ...
              return (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("strong", null, [
                      ...
                      (service.buckets && service.buckets.length)
                        ? (_openBlock(), _createElementBlock("span", {
                          ...
                          }, " [" + _toDisplayString(service.buckets.join(', ')) + "]", 9 /* TEXT, PROPS */, _hoisted_93))
                        : _createCommentVNode("v-if", true)
                    ]),
                ...
                (_ctx.isAdmin)
                  ? (_openBlock(), _createElementBlock("button", {
                    ...
                    }, _toDisplayString(_ctx.restartBusy === service.service ? "处理中" : "重启"), 9 /* TEXT, PROPS */, _hoisted_94))
                  : _createCommentVNode("v-if", true)
              ]))
            }), 128 /* KEYED_FRAGMENT */)),
            (!_ctx.services.length)
              ? (_openBlock(), _createElementBlock("div", _hoisted_95, "等待服务采样"))
              : _createCommentVNode("v-if", true)
          ])
        ]),
          ...
          _createElementVNode("div", _hoisted_98, [
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.alerts, (alert) => {
              return (_openBlock(), _createElementBlock("div", {
                ...
                _cache[50] || (_cache[50] = _createElementVNode("span", { class: "alert-icon" }, "!", -1 /* CACHED */)),
                _createElementVNode("div", null, [
            ...
            (!_ctx.alerts.length)
              ? (_openBlock(), _createElementBlock("div", _hoisted_99, _cache[51] || (_cache[51] = [
      ...
      _cache[52] || (_cache[52] = _createElementVNode("footer", null, [
